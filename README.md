...
**Transit Opportunity Cost App** — A React app that calculates the true cost of public transit using your hourly wage. Learning React and mapping APIs through this one.

**Autonomous Magnetic Chessboard** — A physical board that moves its own pieces via a CoreXY gantry and Raspberry Pi. The most ambitious thing I've attempted — a collision avoidance algorithm is the hard part.
